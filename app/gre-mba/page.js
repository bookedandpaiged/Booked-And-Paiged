  ...
  return (
    <div>
      <div className="module-header">
        ...
        <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic', fontSize: '16px', letterSpacing: '0.03em' }}>Daily study blocks, weekly tasks, monthly milestones, and score tracking</p>
      </div>
