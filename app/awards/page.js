  ...
  return (
    <div>
      <div className="module-header">
        ...
        <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic', fontSize: '16px', letterSpacing: '0.03em' }}>Award details, submission tasks, and daily checklist</p>
      </div>
