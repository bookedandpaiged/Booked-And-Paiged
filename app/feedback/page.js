  ...
  return (
    <div>
      <div className="module-header">
        ...
        <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic', fontSize: '16px', letterSpacing: '0.03em' }}>Notes on what is working, what is not, and what to build next</p>
      </div>
