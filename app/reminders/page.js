  ...
  return (
    <div>
      <div className="module-header">
        ...
        <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic', fontSize: '16px', letterSpacing: '0.03em' }}>Bills, grooming, pet care, car maintenance, cleaning, and to-dos</p>
      </div>
